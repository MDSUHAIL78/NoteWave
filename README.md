<img width="1066" alt="Screenshot 2023-09-06 182422" src="https://github.com/MDSUHAIL78/NoteWave/assets/95640854/f3c380e6-7c09-4baa-9a3c-64f8ddc6f279">
...
NoteWave is a web app that allows users to store their important notes and code snippets securely on the cloud. The app is built using the MERN stack (MongoDB, Express, React, and Node.js), and it features all the essential security measures, such as authentication, authorization, and encryption.

With NoteWave, users can:
...
```bash
git clone https://github.com/MDSUHAIL78/NoteWave.git
```
